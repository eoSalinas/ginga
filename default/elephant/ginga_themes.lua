--
-- Dynamic Ginga Theme Menu for Elephant/Walker
--
Name = "gingathemes"
NamePretty = "Ginga Themes"

-- The main function elephant will call
function GetEntries()
	local entries = {}
	local theme_dir = os.getenv("HOME") .. "/.config/ginga/themes"
		...
		if theme_name then
			...
			if preview_path and preview_path ~= "" then
				...
				table.insert(entries, {
					...
					PreviewType = "file",
					Actions = {
						activate = "ginga-theme-set " .. theme_name,
					},
				})
			end
		end
